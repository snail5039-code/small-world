...
- 기능 기준 커밋: `865b4e4` (`feat(stage15): 장례식 없는 묘지 씬 통합`)
...
- 15단계 구현 현황: 프롤로그부터 5장 `장례식 없는 묘지`까지의 진행과 `04_StoryRoute` 장면 연결이 구현되었습니다.
...
- 다음 구현 범위: 6장 `창문 안의 도시`.
- 최신 검증: Unity 6000.3.18f1 일반 Editor Test Runner에서 EditMode 178/178, PlayMode 18/18 통과, Windows Development 빌드 성공, 런타임 스모크 PASS.
