...
> 목적: 외부 에셋의 출처, 이용 조건, 증빙과 검증 상태를 관리합니다.
> 읽는 경우: 외부 에셋 도입 전, 통합 리뷰, 출시 고지 점검 시.
> 관련 문서: [`../decisions/PROJECT_DECISIONS.md`](../decisions/PROJECT_DECISIONS.md), [`../CURRENT_STATUS.md`](../CURRENT_STATUS.md), [분리 시점 원문](../archive/THIRD_PARTY_ASSETS.original.md)
