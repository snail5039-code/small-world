...
- 기능 기준 커밋: `a0b8723` (`fix(stage15): 상자형 스토리 방 시각 구성 개선`)
...
- 디자인 상태: 반복 상자 갤러리를 제거하고 150개 행동을 인물·가구·문·문서·시계·신분증·묘비·모니터·케이블·창문·식기·관리 코어 등 의미 오브젝트로 구분했습니다. 프롤로그 유나 실루엣·얼굴·표지·키라이트, 중앙 통로, 조명 대비를 보강했습니다. 최종 아트·텍스처·사운드와 실제 퍼즐 조작 연출은 아직 필요합니다.
...
- 최신 검증: Unity 6000.3.18f1 일반 Editor Test Runner에서 EditMode 202/202, PlayMode 50/50 통과, Windows Development 빌드 성공, 런타임 스모크 PASS.
